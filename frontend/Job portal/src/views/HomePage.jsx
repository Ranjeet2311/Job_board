      ...
      <div className="row second-section">
        ...
        <div className="col-12 col-md-6">
          ...
          <p>
            ...
            Search tools let you quickly look someone up whilst our company view
            provides an elegant way to visualise team structures. Team today is
            designed for teams who {`haven't`} got time for complex training or
            set up. Give it a try and see how easy it is to create and manage
            teams. Sync with Azure to manage your leavers and joiners process.
          </p>
        </div>
